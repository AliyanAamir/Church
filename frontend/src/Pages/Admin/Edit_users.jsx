            ...
            <div className="col-12">
              <div className="profile__content">
                ...
                <div className="profile__user">
                  ...
                  {/* <!-- or red --> */}
                  <div className={`profile__meta ${userData?.status==='approved'?'profile__meta--green':'profile__meta--red'}`}>
                    <h3>
                      {`${userData?.first_name} ${userData?.last_name}`} <span>({userData?.status})</span>
                    </h3>
