...
export default function EditUsers() {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post("http://localhost:8000/api/user/changepassword/", passwords, {
        headers: {
                      ...
                      <div className="col-12 col-lg-6">
                        ...
                        >
                          <div className="row">
                            ...
                            {/* <div className="col-12 col-md-6 col-lg-12 col-xl-6">
													<div className="sign__group">
														<label className="sign__label" for="subscription">Subscription</label>
                            ...
                            {/* <div className="col-12 col-md-6 col-lg-12 col-xl-6">
													<div className="sign__group">
														<label className="sign__label" for="rights">Rights</label>
                      ...
                      <div className="col-12 col-lg-6">
                        ...
                        >
                          <div className="row">
                            ...
                            <div className="col-12">
                              <button onClick={handleSubmit} className="sign__btn" type="button">
                                Change
                              </button>
                            </div>
                          </div>
